...
LispPTR
n_new_cursorin(DLword *baseaddr, int dx, int dy, int w, int h)
{
...
newbltchar(register BLTARG *args)
{
...
LispPTR
changecharset_display(register DISPLAYDATA *displaydata68k,
					  DLword charset)
{
