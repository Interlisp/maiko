/* $Id: colorbltfns.c,v 1.2 1999/01/03 02:06:52 sybalsky Exp $ (C) Copyright Venue, All Rights Reserved  */
...
LispPTR args[];
{
	...
	for( i=0, d_base += d_left; i<height; 
	   ...
	   , (DLword*)d_base += d_bitmap->bmrasterwidth ) {
